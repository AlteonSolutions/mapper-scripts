...
(function() {
    ...
    // ── BRAND CONFIG ─────────────────────────────────────────────────────────
    var formId = '5GIq2FyRJrWJv32C9avI';
    var icons = {
    ...
    industries.forEach(function(ind) {
        ...
        btn.innerHTML = '<div class="category-icon"><img src="' + icons[ind.key] + '" alt="' + ind.label + '"></div>'
    ...
    var formBase = 'https://api.leadconnectorhq.com/widget/form/' + formId;
    if (iframe) {
    ...
    window.selectIndustry = function(fileCategory, mapperKey, industryLabel) {
        ...
        badge.innerHTML = 'staffing-selector.js ' + VERSION + '<br>staffing-mapper.js v8.3';
