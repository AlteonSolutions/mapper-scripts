(function() {
    ...
    function init() {
        ...
        waitForElement('#uploadTitle', function(titleEl) {
            ...
            titleEl.textContent = 'Client Data File Upload'; var ts = new Date(); var tstr = (ts.getMonth()+1) + '/' + ts.getDate() + ' ' + ts.getHours() + ':' + String(ts.getMinutes()).padStart(2,'0') + ':' + String(ts.getSeconds()).padStart(2,'0'); titleEl.textContent += ' [JS ' + tstr + ']';
        });
